...
public:
    static std::string hash(const std::string& input) {
        ...
        // Append length as 64-bit integer (Big Endian)
        for (int i = 7; i >= 0; --i) {
...
int main() {
    ...
    std::string hashOutput = SHA256::hash(input);
    std::cout << "SHA-256 Hash Digest: " << hashOutput << std::endl;
